<?php $__env->startSection('title', 'Register – Peace Institute'); ?>
    ...
    <div class="reg-wrap">
        ...
        <div class="text-center">
            ...
            <h1 style="font-size:2rem;font-weight:800;color:var(--text);margin-bottom:.3rem;">
                <?php echo e($role === 'teacher' ? 'Apply to Teach' : 'Start Learning Today'); ?>

            </h1>
            <p style="color:var(--muted);font-size:.95rem;margin-bottom:1.5rem;">
                <?php echo e($role === 'teacher' ? 'Join our team of certified Quran teachers worldwide' : 'Create your free student account in under a minute'); ?>
        ...
        <div class="role-toggle">
            <a href="<?php echo e(route('register', 'student')); ?>"
               class="role-tab <?php echo e($role === 'student' ? 'active' : ''); ?>">
                <i class="fas fa-graduation-cap"></i> Student
            </a>
            <a href="<?php echo e(route('register', 'teacher')); ?>"
               class="role-tab <?php echo e($role === 'teacher' ? 'active' : ''); ?>">
        ...
        <div class="reg-card">
            <h2 class="reg-card-title">
                <?php echo e($role === 'teacher' ? 'Teacher Application' : 'Create Your Account'); ?>

            </h2>
            <p class="reg-card-sub">
                <?php echo e($role === 'teacher' ? 'Fill in your details — our team will review and contact you.' : 'All fields marked * are required.'); ?>
                ...
                <div style="display:flex;flex-direction:column;gap:1rem;">
                    ...
                    <div class="frm-row cols-2">
                        <div class="frm-group">
                            ...
                            <input class="frm-input" id="name" type="text" name="name"
                                value="<?php echo e(old('name')); ?>" required placeholder="Your full name">
                        </div>
                        <div class="frm-group">
                            ...
                            <input class="frm-input" id="phone" type="tel" name="phone"
                                value="<?php echo e(old('phone')); ?>" placeholder="+1 234 567 890">
                        </div>
                    </div>
                    ...
                    <div class="frm-group">
                        ...
                        <input class="frm-input" id="email" type="email" name="email"
                            value="<?php echo e(old('email')); ?>" required placeholder="you@example.com">
                    </div>
                        ...
                        <div class="sel-wrap">
                            <select class="frm-select" id="timezone" name="timezone">
                                <?php $__currentLoopData = timezone_identifiers_list(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($tz); ?>" <?php echo e($tz === 'UTC' ? 'selected' : ''); ?>><?php echo e($tz); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="rate-box">
                            ...
                            <div class="frm-group">
                                <input class="frm-input" type="number" name="hourly_rate"
                                    value="<?php echo e(old('hourly_rate', 15)); ?>" min="5" step="0.50"
                                    placeholder="15.00">
                    ...
                    <button type="submit" class="reg-submit" style="margin-top:.5rem;">
                        ...
                        <?php echo e($role === 'teacher' ? 'Submit Application' : 'Create Free Account'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Peace Institute\Website\resources\views/auth/register.blade.php ENDPATH**/ ?>