<?php $__env->startSection('title', 'Sign In – Peace Institute'); ?>
...
<div class="auth-wrap">
    ...
    <div class="auth-form-side">
        <div class="auth-card">
            ...
            <?php if($errors->any()): ?>
                <div class="err-box"><i class="fas fa-exclamation-circle mr-2"></i><?php echo e($errors->first()); ?></div>
            <?php endif; ?>
            ...
            <p style="text-align:center;font-size:.75rem;color:#9CA3AF;margin-top:1.5rem;">
                Are you a teacher?
                <a href="<?php echo e(route('register', 'teacher')); ?>" class="auth-link" style="font-size:.75rem;">Apply to teach →</a>
            </p>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Peace Institute\Website\resources\views/auth/login.blade.php ENDPATH**/ ?>