<?php $__env->startSection('title', 'Peace Institute – Online Quran Academy'); ?>
<?php $__env->startSection('meta_description', 'Learn Quran online with certified male & female teachers. Courses in Qaida, Nazra, Tajweed, Hifz, Tafseer & Dars-e-Nizami. First class free.'); ?>
...
<section class="hero">
    ...
    <div class="hero-left">
        ...
        <div style="display:flex;gap:12px;flex-wrap:wrap;margin-bottom:32px">
            <a href="<?php echo e(route('courses')); ?>" class="hero-btn-gold">
                <i class="fas fa-book-open"></i> Explore Courses
            </a>
            <a href="<?php echo e(route('teachers')); ?>" class="hero-btn-ghost">
        ...
        <div style="display:flex;align-items:center;gap:20px;flex-wrap:wrap">
            <div style="display:flex;align-items:center;gap:8px">
                <div style="display:flex">
                    <?php $__currentLoopData = ['SM','ZB','AA']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $init): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div style="width:30px;height:30px;border-radius:50%;background:linear-gradient(135deg,var(--gold),var(--goldd));border:2px solid rgba(255,255,255,.3);display:flex;align-items:center;justify-content:center;font-size:.6rem;font-weight:800;color:#0F1F0A;margin-right:-8px;z-index:<?php echo e($loop->index + 1); ?>"><?php echo e($init); ?></div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <span style="font-size:.78rem;color:rgba(255,255,255,.55)"><?php echo e($stats['teachers'] ?? 50); ?>+ Certified Teachers</span>
            </div>
            ...
            <div style="font-size:.78rem;color:rgba(255,255,255,.55)">
                ...
                <?php echo e($stats['students'] ?? 1200); ?>+ Happy Students
            </div>
        </div>
    </div>
    ...
    <div class="hero-right">
        <div class="form-card">
            ...
            <form action="<?php echo e(route('register', 'student')); ?>" method="GET">
...
<div class="stats-bar">
    <div class="stat-item"><div class="stat-num"><?php echo e($stats['teachers'] ?? 50); ?>+</div><div class="stat-lbl">Certified Teachers</div></div>
    <div class="stat-div"></div>
    <div class="stat-item"><div class="stat-num"><?php echo e($stats['students'] ?? 1200); ?>+</div><div class="stat-lbl">Active Students</div></div>
    <div class="stat-div"></div>
    <div class="stat-item"><div class="stat-num"><?php echo e($stats['countries'] ?? 25); ?>+</div><div class="stat-lbl">Countries</div></div>
    <div class="stat-div"></div>
    <div class="stat-item"><div class="stat-num"><?php echo e($stats['sessions'] ?? 8500); ?>+</div><div class="stat-lbl">Sessions Completed</div></div>
    <div class="stat-div"></div>
...
<section class="features">
    <div class="feat-grid">
        ...
        <div class="feat reveal d1">
            ...
            <a href="<?php echo e(route('register', 'student')); ?>" class="feat-link">Enroll Free →</a>
        </div>
        ...
        <div class="feat reveal d2">
            ...
            <a href="<?php echo e(route('teachers')); ?>" class="feat-link">Meet Them →</a>
        </div>
        ...
        <div class="feat reveal d3">
            ...
            <a href="<?php echo e(route('register', 'student')); ?>" class="feat-link">How It Works →</a>
        </div>
        ...
        <div class="feat reveal d4">
            ...
            <a href="<?php echo e(route('register', 'student')); ?>" class="feat-link">Book a Slot →</a>
        </div>
...
<section class="courses">
    <div class="courses-inner">
            ...
            <div class="c-card reveal d1">
                ...
                <div class="c-body">
                    ...
                    <div class="c-meta">
                        ...
                        <a href="<?php echo e(route('register', 'student')); ?>" class="c-enroll">Enroll →</a>
                    </div>
                </div>
            </div>
            ...
            <div class="c-card reveal d2" style="border:2px solid rgba(201,164,39,.25)">
                ...
                <div class="c-body">
                    ...
                    <div class="c-meta">
                        ...
                        <a href="<?php echo e(route('register', 'student')); ?>" class="c-enroll c-enroll-gold">Enroll →</a>
                    </div>
                </div>
            </div>
            ...
            <div class="c-card reveal d5">
                ...
                <div class="c-body">
                    ...
                    <div class="c-meta">
                        ...
                        <a href="<?php echo e(route('register', 'student')); ?>" class="c-enroll c-enroll-gold">Apply →</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="text-center reveal" style="margin-top:40px">
            <a href="<?php echo e(route('courses')); ?>" style="display:inline-flex;align-items:center;gap:8px;color:var(--green);font-weight:700;font-size:.9rem;text-decoration:none;border:1.5px solid rgba(26,107,60,.3);padding:12px 28px;border-radius:10px;transition:all .25s"
...
<section class="teachers">
    <div class="teachers-inner">
        ...
        <div class="teachers-grid">
            ...
            <?php if($featuredTeachers->count()): ?>
                <?php $__currentLoopData = $featuredTeachers->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="t-card reveal" style="display:<?php if(!$loop->first): ?> block <?php else: ?> block <?php endif; ?>">
                    <div class="t-card-top" style="background:linear-gradient(135deg,var(--gd),var(--green))">
                        <img src="<?php echo e($teacher->user->avatar_url); ?>" alt="<?php echo e($teacher->user->name); ?>"
                    ...
                    <div class="t-card-body">
                        <div class="t-role"><?php echo e($teacher->specialization); ?></div>
                        <h3><?php echo e($teacher->user->name); ?></h3>
                        <p><?php echo e(Str::limit($teacher->bio, 90)); ?></p>
                        <div class="t-cred-sm">
                            <i class="fas fa-star" style="color:var(--gold)"></i>
                            Rating: <?php echo e(number_format($teacher->rating, 1)); ?>/5 (<?php echo e($teacher->total_reviews); ?> reviews)
                        </div>
                        <div style="display:flex;align-items:center;justify-content:space-between;margin-top:14px;padding-top:12px;border-top:1px solid rgba(0,0,0,.06)">
                            <span style="font-size:.8rem;font-weight:700;color:var(--text)">$<?php echo e(number_format($teacher->hourly_rate,0)); ?>/hr</span>
                            <a href="<?php echo e(route('teachers.show', $teacher)); ?>" class="c-enroll" style="font-size:.74rem;padding:6px 14px">Book →</a>
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-top:40px;flex-wrap:wrap;gap:16px" class="reveal">
            <a href="<?php echo e(route('teachers')); ?>" style="display:inline-flex;align-items:center;gap:8px;color:var(--green);font-weight:700;font-size:.9rem;text-decoration:none;border:1.5px solid rgba(26,107,60,.3);padding:12px 28px;border-radius:10px;transition:all .25s"
               onmouseover="this.style.background='var(--green)';this.style.color='#fff'" onmouseout="this.style.background='transparent';this.style.color='var(--green)'">
            ...
            <div style="display:flex;align-items:center;gap:14px;background:rgba(26,107,60,.05);border:1px solid rgba(26,107,60,.12);border-radius:12px;padding:14px 22px">
                ...
                <a href="<?php echo e(route('register', 'teacher')); ?>" style="color:var(--green);font-weight:700;font-size:.84rem;text-decoration:none;border-bottom:1px solid rgba(26,107,60,.3);padding-bottom:1px">Join Our Teaching Team →</a>
            </div>
        </div>
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:22px">
            ...
            <div style="background:#fff;border-radius:16px;padding:24px;box-shadow:0 2px 12px rgba(0,0,0,.06)" class="reveal">
                <div style="display:flex;gap:3px;margin-bottom:12px">
                    <?php for($i=1;$i<=5;$i++): ?>
                        <i class="fas fa-star" style="font-size:.78rem;color:<?php echo e($i<=$review->rating ? '#F59E0B' : '#E5E7EB'); ?>"></i>
                    <?php endfor; ?>
                </div>
                <p style="font-size:.83rem;color:var(--muted);line-height:1.75;margin-bottom:16px">"<?php echo e($review->comment); ?>"</p>
                <div style="display:flex;align-items:center;gap:10px;padding-top:14px;border-top:1px solid rgba(0,0,0,.06)">
                    <img src="<?php echo e($review->student->user->avatar_url); ?>" style="width:36px;height:36px;border-radius:50%;object-fit:cover" alt="">
                    <div>
                        <div style="font-size:.82rem;font-weight:700;color:var(--text)"><?php echo e($review->student->user->name); ?></div>
                        <div style="font-size:.72rem;color:var(--muted)">Student of <?php echo e($review->teacher->user->name); ?></div>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<section class="cta-sec">
    <div class="cta-inner reveal">
        ...
        <div class="cta-text">
            ...
            <div class="cta-btns">
                <a href="<?php echo e(route('register', 'student')); ?>" class="cta-btn-g">
                    <i class="fas fa-plus"></i> Enroll Now — It's Free
                </a>
                <a href="<?php echo e(route('teachers')); ?>" class="cta-btn-w">
        ...
        <div class="cta-stats">
            <h4>Our Impact</h4>
            <div class="s-row"><span class="slbl">Expert Teachers</span><span class="sval"><?php echo e($stats['teachers'] ?? 50); ?>+</span></div>
            <div class="s-row"><span class="slbl">Active Students</span><span class="sval"><?php echo e($stats['students'] ?? 1200); ?>+</span></div>
            <div class="s-row"><span class="slbl">Countries</span><span class="sval"><?php echo e($stats['countries'] ?? 25); ?>+</span></div>
            <div class="s-row"><span class="slbl">Sessions Done</span><span class="sval"><?php echo e($stats['sessions'] ?? 8500); ?>+</span></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Peace Institute\Website\resources\views/welcome.blade.php ENDPATH**/ ?>