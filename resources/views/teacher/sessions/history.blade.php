...
@section('page-title', 'Class History')
@section('page-subtitle', 'Completed classes you have taught')
...
@section('sidebar-nav')
    ...
    <a href="{{ route('teacher.sessions') }}" class="sidebar-link"><span class="icon"><i class="fas fa-calendar-check"></i></span> Classes</a>
    <a href="{{ route('teacher.sessions.history') }}" class="sidebar-link active"><span class="icon"><i class="fas fa-history"></i></span> Class History</a>
...
<div class="card overflow-hidden">
    <table class="w-full text-sm">
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="7" class="px-5 py-12 text-center text-gray-600">No completed classes yet.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
